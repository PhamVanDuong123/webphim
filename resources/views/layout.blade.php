...
<body class="home blog halimthemes halimmovies" data-masonry="">
            ...
            <div class="col-md-5 col-sm-6 halim-search-form hidden-xs">
               <div class="header-nav">
                  <div class="col-xs-12">
                     ...
                     <ul class="result" id="result" style="display:none"></ul>
               ...
               <div class="menu-menu_1-container">
                  <ul id="menu-menu_1" class="nav navbar-nav navbar-left">
                     ...
                     <li class="mega dropdown">
                        ...
                        <ul role="menu" class=" dropdown-menu">
                           @for($year=2000;$year<=2023;$year++) <li><a title="{{$year}}" href="{{url('nam/'.$year)}}">{{$year}}</a>
                     </li>
                     @endfor
                  </ul>
                  </li>
   ...
   <script type='text/javascript' src='{{asset('public/js/bootstrap.min.js?ver=5.7.2')}}' id='bootstrap-js'></script>
   <script type='text/javascript' src='{{asset('public/js/owl.carousel.min.js?ver=5.7.2')}}' id='carousel-js'></script>
   ...
   <script type="text/javascript">
      $(document).ready(function() {
         $('#timkiem').keyup(function() {
            ...
            if (search != '') {
               $('#result').html('').css('display', 'inherit');
               ...
               $.getJSON('public/json/movies.json', function(data) {
                  ...
                  $.each(data, function(key, value) {
                     ...
                     if (value.title.search(expression) != -1 || value.description
                        ...
                        $('#result').append(
                           '<li style="cursor:pointer; display: flex; max-height: 200px;" class="list-group-item link-class"><img src="public/uploads/movie/' +
                           value.image +
