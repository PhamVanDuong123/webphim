...
class IndexController extends Controller
{
    ...
    public function home(){
        $phimhot = Movie::where('phim_hot',1)->where('status',1)->orderBy('update_at','DESC')->get();
        $phimhot_sidebar = Movie::where('phim_hot',1)->where('status',1)->orderBy('update_at','DESC')->take('20')->get();
        $phim_sapchieu = Movie::where('resolution',5)->where('status',1)->orderBy('update_at','DESC')->take('10')->get();
        $category = Category::orderBy('position','ASC')->where('status',1)->get();
        $genre = Genre::orderBy('id','DESC')->get();
    ...
    public function category($slug){
        ...
        $movie = Movie::where('category_id',$cate_slug->id)->orderBy('update_at','DESC')->paginate(40);
    ...
    public function year($year){
      ...
      $year= $year;
        ...
        $movie = Movie::where('year',$year)->orderBy('update_at','DESC')->paginate(40);
    ...
    public function tag($tag){
      ...
      $tag= $tag;
        ...
        $movie = Movie::where('tags','LIKE','%'.$tag.'%')->orderBy('update_at','DESC')->paginate(40);
    ...
    public function country($slug){
        ...
        $movie = Movie::where('country_id',$country_slug->id)->orderBy('update_at','DESC')->paginate(40);
    ...
    public function movie($slug){
    	...
    	return view('pages.movie', compact('category','genre','country','movie','related','phimhot_sidebar','phim_sapchieu','episode','episode_tapdau','episode_current_count'));
    }
